...
// user_pref("network.trr.uri", "CHANGEME");
// user_pref("network.trr.custom_uri", "CHANGEME");
...
user_pref("sidebar.visability", "always-show");
user_pref("sidebar.position_start", "true"); // true = left, false = right
user_pref("sidebar.verticalTabs", true);
user_pref("sidebar.main.tools", ""); // options: syncedtabs, bookmarks, passwords, history
user_pref("sidebar.expandOnHover", false);

/** BOOKMARKS TOOLBAR ***/
user_pref("browser.toolbars.bookmarks.visibility", "never"); // options: always, never, newtab

/** UI CUSTOMIZATION **/
// user_pref("browser.uiCustomization.state", "CHANGEME"); // export your own state from about:customizing
